...
<form method="post" class="gravatar-cache-form" enctype="multipart/form-data">
  <table class="widefat fixed">
    <tr valign="top">
      ...
      <td>
        <img alt="" src="<?php echo $this->getDefaultAvatar() ?>" class="avatar avatar-96 photo" width="96" height="96" />
      </td>
    </tr>
    <tr valign="top">
    ...
    <tr valign="top">
      <th class="column-columnname column-primary" scope="row"><label for="wp_cache_status"><?php _e('Reset avatar by default', 'OGC'); ?></label></th>
      <td>
        <fieldset>
          <label><input type='checkbox' name='OGC_options[resetDefaultAvatar]' value='1'></label><br />
        </fieldset>
      </td>
    </tr>
    <tr valign="top">
